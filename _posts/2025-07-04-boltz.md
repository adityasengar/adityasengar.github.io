...
Figure 1. Architectural comparison of Boltz vs AlphaFold 3. Boltz-2’s trunk is deeper (64 layers vs 48) and uses optimized kernels, enabling it to process larger complexes with similar or less computational effort than AlphaFold 3.
