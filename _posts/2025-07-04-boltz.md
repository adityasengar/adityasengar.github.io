...
***
[^licensing-status]:
  * **AlphaFold 3** – Launched as a web‑only tool in May 2024; full source + weights became downloadable on **11 Nov 2024** under the Creative Commons **CC‑BY‑NC‑SA 4.0** licence, which allows research but **forbids commercial use**. :contentReference[oaicite:0]{index=0}  
  * **Boltz‑1** – Released in Nov 2024 under the **MIT licence** with model weights, making it the first AF3‑class system that is completely free for **any** purpose, including commercial R & D. :contentReference[oaicite:1]{index=1}  
  * **Chai‑1** – Open‑sourced in Oct 2024 under **Apache‑2.0**; focused on antibody and small‑peptide tasks rather than general protein‑ligand complexes. :contentReference[oaicite:2]{index=2}
